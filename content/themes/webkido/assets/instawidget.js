    ...
    ProfileWidget.prototype = {
		...
		callbackUsername: function(data, o) {
			...
			if(data.data.length > 0) 
			{
				...
				$(o.element).find(".insta-profile-username").text(data.data[0].full_name);
				$(o.element).find(".insta-profile-avatar").append("<img src=\"" + data.data[0].profile_picture + "\">");
